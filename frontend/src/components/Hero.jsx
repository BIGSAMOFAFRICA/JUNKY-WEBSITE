...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1644447381290-85358ae625cb?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
      {/* Overlay */}
      ...
      <div className="relative z-10 text-center text-white px-4">
        ...
        <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
          {" "}
          Experience the taste of perfection — where every bite is satisfaction.
        </p>
